...
void Camera3::Update(double dt)
{
	...
	static const float CAMERA_ROT_SPEED = 50.f;
	...
	//{
	//	Vector3 view = (target - position).Normalized();
	//	float yaw = (float)(-CAMERA_ROT_SPEED * Application::camera_yaw * (float)dt);
	//	Mtx44 rotation;
	//	rotation.SetToRotation(yaw, 0, 1, 0);
	//	view = rotation * view;
	//	target = position + view;
	...
	//}
	//{
	//	float pitch = (float)(-CAMERA_ROT_SPEED * Application::camera_pitch * (float)dt);
	//	Vector3 view = (target - position).Normalized();
	//	Vector3 right = view.Cross(up);
	//	right.y = 0;
	//	right.Normalize();
