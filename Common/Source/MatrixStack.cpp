...
//void MS::Rotate(Vector3& rotateAngles)
//{
//}
...
*/
/******************************************************************************/
void MS::Rotate(Vector3& Rotate) {
	Mtx44 mat;
	mat.SetToRotation(Rotate.x, 1, 0, 0);
	ms.top() = ms.top() * mat;
	mat.SetToRotation(Rotate.z, 0, 0, 1);
	ms.top() = ms.top() * mat;
	mat.SetToRotation(Rotate.y, 0, 1, 0);
	ms.top() = ms.top() * mat;
	//mat.SetToRotation(Rotate.z, 0, 0, 1);
	//ms.top() = ms.top() * mat;
}
...
void MS::Transform(TRS trs)
{
	Mtx44 mat;
	mat.SetToTranslation(trs.translate.x, trs.translate.y, trs.translate.z);
	ms.top() = ms.top() * mat;
	this->Rotate(trs.rotateAngles);
	mat.SetToScale(trs.Scale.x, trs.Scale.y, trs.Scale.z);
	ms.top() = ms.top() * mat;
}
